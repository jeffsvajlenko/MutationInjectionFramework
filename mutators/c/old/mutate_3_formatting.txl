...
function mutate OriginalP [program]
    ...
    deconstruct P
        OriginalP
    by
        P [randomlyAddNewlines]
          [randomlyDeleteNewlines]
	  [mutate OriginalP]
end function

% For each pair of tokens in the input, randomly add a newline between them
rule randomlyAddNewlines
