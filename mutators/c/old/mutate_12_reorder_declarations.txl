% Mutate with declaration reordering in any C program 
#pragma -char -comment
...
function checkMutatable
    ...
    deconstruct not * [repeat line] P
        Declaration1 [declaration_line]
        Declaration2 [declaration_line]
	OtherLines [repeat line]
    construct Message [id]
        _ [message "*** ERROR: mutate_12_reorder_declarations cannot mutate this file"] [quit 99]
end function
