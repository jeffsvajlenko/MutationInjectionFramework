% Mutate with line insertion in any program in any C-like language
#pragma -char -comment
...
function checkMutatable
    ...
    construct Message [id]
        _ [message "*** ERROR: mutate_9_insert_line cannot mutate this file"] [quit 99]
end function
...
rule randomlyInsertSimpleLine
    ...
    deconstruct Random
        1
    deconstruct * [simple_line] OtherLines
    	NewSimpleLine [simple_line]
    by
	NewSimpleLine
        SimpleLine
	OtherLines
