    ...
    throws PathException
    {
        ...
        while (!pi.isDone())
        {
            ...
            case PathIterator.SEG_LINETO:
                 ...
                 * [LOWER_BND, UPPER_BND] range. This check also handles NaN
                 * and Infinity values. Ignoring current path segment in case  * of invalid data. If segment is skipped its endpoint
            ...
            case PathIterator.SEG_QUADTO:
                 ...
                 * [LOWER_BND, UPPER_BND] range. This check also handles NaN
                 * and Infinity values. Ignoring current path segment in case  * of invalid endpoints's data. Equivalent to the SEG_LINETO
        ...
        r.beginPath();
        {
            ...
            while (!pi.isDone())
            {
                ...
                case PathIterator.SEG_MOVETO:
                    ...
                    /* Checking SEG_MOVETO coordinates if they are out of the
                     * [LOWER_BND, UPPER_BND] range. This check also handles NaN
                     * and Infinity values. Skipping next path segment in case  * of invalid data.
                     */
