...
public class XExtCodes extends XWrapperBase
{
    ...
    public void set_extension(int v)
    {
        log.finest("");
        Native.putInt(pData+0, v);
    }
    public int get_major_opcode()
    {
        log.finest("");
        return (Native.getInt(pData+4));
    }
    public void set_major_opcode(int v)
    {
        log.finest("");
        Native.putInt(pData+4, v);
    }
    public int get_first_event()
    {
        log.finest("");
        return (Native.getInt(pData+8));
    }
    public void set_first_event(int v)
    {
        log.finest("");
        Native.putInt(pData+8, v);
    }
    public int get_first_error()
    {
        log.finest("");
        return (Native.getInt(pData+12));
    }
    public void set_first_error(int v)
    {
        log.finest("");
