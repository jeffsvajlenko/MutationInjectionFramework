...
public class ColorEntry extends XWrapperBase
{
    ...
    {
        log.finest("");
        return (Native.getByte(pData+2));
    }
    public void set_b(byte v)
    {
        log.finest("");
        Native.putByte(pData+2, v);
    }
    public byte get_flags()
    {
        log.finest("");
        return (Native.getByte(pData+3));
    }
    public void set_flags(byte v)
    {
        log.finest("");
        Native.putByte(pData+3, v);
    }
