...
public class XUnmapEvent extends XWrapperBase
{
    ...
    public boolean get_from_configure()
    {
        log.finest("");
        return (Native.getBool(pData+24));
    }
    public void set_from_configure(boolean v)
    {
        log.finest("");
        Native.putBool(pData+24, v);
    }
