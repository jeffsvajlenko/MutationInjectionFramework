...
public class SearchFilter implements AttrFilter
{
    ...
    protected void normalizeFilter()
    {
        ...
        if(debug)
        {
            System.out.println("SearchFilter: normalized filter:" +
                               filter);
        }
    }
    ...
    protected String relSubstring(int beginIndex, int endIndex)
    {
        if(debug)
        {
            System.out.println("relSubString: " + beginIndex +
                               " " + endIndex);
        }
    ...
    final class AtomicFilter implements StringFilter
    {
        ...
        public void parse() throws InvalidSearchFilterException
        {
            ...
            if(debug)
            {
                System.out.println("AtomicFilter: " + attrID + "=" +
                                   value);
            }
        }
        ...
        public boolean check(Attributes targetAttrs)
        {
            ...
            catch (NamingException ne)
            {
                if (debug)
                {
                    System.out.println("AtomicFilter: should never " +
                                       "here");
                }
                return false;
            }
            ...
            while(candidates.hasMoreElements())
            {
                ...
                default:
                    if (debug)
                    {
                        System.out.println("AtomicFilter: unkown " +
                                           "matchType");
                    }
                }
            }
