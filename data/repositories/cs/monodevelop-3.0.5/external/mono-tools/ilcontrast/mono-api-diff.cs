...
public class Counters
{
    ...
    public int AbsTotal
    {
        get
        {
            return PresentTotal + MissingTotal;
        }
    }
    ...
    public int OkTotal
    {
        get
        {
            return PresentTotal - TodoTotal - ErrorTotal;
        }
    }
...
class XMLGenericTypeConstraints : XMLGenericGroup
{
    public override string GroupName
    {
        get
        {
            return "generic-type-constraints";
        }
    }
    ...
    public override string Name
    {
        get
        {
            return "generic-type-constraint";
        }
    }
}
...
class XMLGenericMethodConstraints : XMLGenericGroup
{
    public override string GroupName
    {
        get
        {
            return "generic-method-constraints";
        }
    }
    ...
    public override string Name
    {
        get
        {
            return "generic-method-constraint";
        }
    }
}
