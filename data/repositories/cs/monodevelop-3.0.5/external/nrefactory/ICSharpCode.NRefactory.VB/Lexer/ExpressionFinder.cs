...
public partial class ExpressionFinder
{
    ...
    void PushContext(Context context, Token la, Token t)
    {
        ...
        {
            context = context, lastExpressionStart = l
        });
    ...
    public Block CurrentBlock
    {
        get
        {
            return stack.Any() ? stack.Peek() : Block.Default;
        }
    }
    ...
    public bool NextTokenIsPotentialStartOfExpression
    {
        get
        {
            return nextTokenIsPotentialStartOfExpression;
        }
    }
    ...
    public bool ReadXmlIdentifier
    {
        get
        {
            return readXmlIdentifier;
        }
        set
        {
            readXmlIdentifier = value;
        }
    }
    ...
    public bool NextTokenIsStartOfImportsOrAccessExpression
    {
        get
        {
            return nextTokenIsStartOfImportsOrAccessExpression;
        }
    }
    ...
    public bool WasQualifierTokenAtStart
    {
        get
        {
            return wasQualifierTokenAtStart;
        }
    }
