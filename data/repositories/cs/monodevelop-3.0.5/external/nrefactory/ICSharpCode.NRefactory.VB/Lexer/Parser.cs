...
partial class ExpressionFinder
{
    ...
    public void InformToken(Token la)
    {
        ...
        case 216:
        {
            if (!isAlreadyInExpr) PopContext();
            isAlreadyInExpr = false;
            currentState = stateStack.Pop();
            goto switchlbl;
        }
        case 217:
    ...
    public BitArray GetExpectedSet()
    {
        return GetExpectedSet(currentState);
    }
