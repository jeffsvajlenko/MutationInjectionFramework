...
public partial class MainWindowController : MonoMac.AppKit.NSWindowController
{
    ...
    public override void AwakeFromNib ()
    {
        ...
        browserView.BackgroundWasRightClicked += delegate
        {
            Console.WriteLine ("BackgroundWasRightClicked");
        };
        browserView.SelectionDidChange += delegate
        {
            Console.WriteLine ("SelectionDidChange");
        };
        browserView.CellWasDoubleClicked += delegate
        {
            Console.WriteLine ("CellWasDoubleClicked");
        };
        browserView.CellWasRightClicked += delegate
        {
            Console.WriteLine ("CellWasRightClicked");
        };
    }
