...
public class AppleDocEventArgs : EventArgs
{
    ...
    {
        get;    // Used during Downloading stage, a value of -1 indicates the stage just started
        set;
    }
    public string CurrentFile
    {
        get;    // User during Extracting/Merging stage, a value of null indicates the stage just started
        set;
    }
}
