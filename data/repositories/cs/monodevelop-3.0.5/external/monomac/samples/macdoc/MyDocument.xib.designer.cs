...
{
    [Outlet]
    MonoMac.AppKit.NSSegmentedCell navigationCells
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSOutlineView outlineView
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSTableView searchResults
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.WebKit.WebView webView
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSTabView tabSelector
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSView spinnerView
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSProgressIndicator spinnerWidget
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSView indexSpinnerView
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSProgressIndicator indexSpinnerWidget
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSButton addBookmarkBtn
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSPopUpButton bookmarkSelector
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSButton viewBookmarksBtn
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSSegmentedCell bookmarkToolbar
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSSplitView splitView
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSTableView multipleMatchResults
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSTableView indexResults
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSSearchField indexSearchEntry
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSSearchField toolbarSearchEntry
    {
        get;
        set;
    }
    ...
    [Outlet]
    MonoMac.AppKit.NSScrollView searchScrollView
    {
        get;
        set;
    }
