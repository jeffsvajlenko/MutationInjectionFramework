...
public interface NSEntityDescription
{
    ...
    [Export ("properties")]
    NSPropertyDescription[] Properties
    {
        get;
        set;
    }
    ...
    NSPropertyDescription [] CompoundIndexes
    {
        get;
        set;
    }
...
public interface NSEntityMapping
{
    ...
    NSPropertyMapping[] AttributeMappings
    {
        get;
        set;
    }
    ...
    NSPropertyMapping[] RelationshipMappings
    {
        get;
        set;
    }
...
public interface NSFetchRequest
{
    ...
    NSPersistentStore[] AffectedStores
    {
        get;
        set;
    }
    ...
    string[] RelationshipKeyPathsForPrefetching
    {
        get;
        set;
    }
    ...
    NSPropertyDescription [] PropertiesToGroupBy
    {
        get;
        set;
    }
...
public interface NSMappingModel
{
    ...
    NSEntityMapping[] EntityMappings
    {
        get;
        set;
    }
...
interface NSMergeConflict
{
    ...
    uint NewVersionNumber
    {
        get;
    }

    [Export ("oldVersionNumber")]
    uint OldVersionNumber
    {
        get;
    }
...
public interface NSPersistentStore
{
    ...
    NSString SaveConflictsErrorKey
    {
        get;
    }
...
public interface NSPersistentStoreCoordinator
{
    ...
    NSPersistentStore[] PersistentStores
    {
        get;
    }
    ...
    NSString SQLiteStoreType
    {
        get;
    }
#if MONOMAC
    [Field ("NSXMLStoreType")]
    NSString XMLStoreType
    {
        get;
    }
#endif
    [Field ("NSBinaryStoreType")]
    NSString BinaryStoreType
    {
        get;
    }

    [Field ("NSInMemoryStoreType")]
    NSString InMemoryStoreType
    {
        get;
    }

    [Field ("NSStoreUUIDKey")]
    NSString StoreUUIDKey
    {
        get;
    }

    [Field ("NSAddedPersistentStoresKey")]
    NSString AddedPersistentStoresKey
    {
        get;
    }

    [Field ("NSRemovedPersistentStoresKey")]
    NSString RemovedPersistentStoresKey
    {
        get;
    }

    [Field ("NSUUIDChangedPersistentStoresKey")]
    NSString UUIDChangedPersistentStoresKey
    {
        get;
    }

    [Field ("NSReadOnlyPersistentStoreOption")]
    NSString ReadOnlyPersistentStoreOption
    {
        get;
    }
#if MONOMAC
    [Field ("NSValidateXMLStoreOption")]
    NSString ValidateXMLStoreOption
    {
        get;
    }
#endif
    [Field ("NSPersistentStoreTimeoutOption")]
    NSString PersistentStoreTimeoutOption
    {
        get;
    }

    [Field ("NSSQLitePragmasOption")]
    NSString SQLitePragmasOption
    {
        get;
    }

    [Field ("NSSQLiteAnalyzeOption")]
    NSString SQLiteAnalyzeOption
    {
        get;
    }
    ...
    NSString IgnorePersistentStoreVersioningOption
    {
        get;
    }

    [Field ("NSMigratePersistentStoresAutomaticallyOption")]
    NSString MigratePersistentStoresAutomaticallyOption
    {
        get;
    }

    [Field ("NSInferMappingModelAutomaticallyOption")]
    NSString InferMappingModelAutomaticallyOption
    {
        get;
    }

    [Field ("NSStoreModelVersionHashesKey")]
    NSString StoreModelVersionHashesKey
    {
        get;
    }

    [Field ("NSStoreModelVersionIdentifiersKey")]
    NSString StoreModelVersionIdentifiersKey
    {
        get;
    }

    [Field ("NSPersistentStoreOSCompatibility")]
    NSString PersistentStoreOSCompatibility
    {
        get;
    }

    [Field ("NSStoreTypeKey")]
    NSString StoreTypeKey
    {
        get;
    }

    [Field ("NSPersistentStoreCoordinatorStoresDidChangeNotification")]
    NSString StoresDidChangeNotification
    {
        get;
    }

    [Field ("NSPersistentStoreCoordinatorWillRemoveStoreNotification")]
    NSString WillRemoveStoreNotification
    {
        get;
    }
    ...
    NSString DidImportUbiquitousContentChangesNotification
    {
        get;
    }
    ...
    NSString PersistentStoreUbiquitousContentNameKey
    {
        get;
    }

    [Field ("NSPersistentStoreUbiquitousContentURLKey")]
    NSString PersistentStoreUbiquitousContentUrlLKey
    {
        get;
    }

    [Field ("NSPersistentStoreFileProtectionKey")]
    NSString PersistentStoreFileProtectionKey
    {
        get;
    }
}
...
public interface NSPropertyDescription
{
    ...
    {
        get;
        [Bind("setTransient:")] set;
    }

    [Export ("validationPredicates")]
    NSPredicate[] ValidationPredicates
    {
        get;
    }
    ...
    bool IndexedBySpotlight
    {
        [Bind ("isIndexedBySpotlight")]get;
        set;
    }

    [Since (5,0)]
    [Export ("storedInExternalRecord")]
    bool StoredInExternalRecord
    {
        [Bind ("isStoredInExternalRecord")]get;
        set;
    }
}
[BaseType (typeof (NSObject))]
