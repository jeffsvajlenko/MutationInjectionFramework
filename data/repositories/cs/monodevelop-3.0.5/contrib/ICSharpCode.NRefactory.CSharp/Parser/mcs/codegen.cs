...
public class EmitContext : BuilderContext
{
    ...
    public TypeSpec CurrentType
    {
        get
        {
            return member_context.CurrentType;
        }
    }
    ...
    public TypeParameters CurrentTypeParameters
    {
        get
        {
            return member_context.CurrentTypeParameters;
        }
    }
    ...
    public MemberCore CurrentTypeDefinition
    {
        get
        {
            return member_context.CurrentMemberDefinition;
        }
    }
    ...
    public bool IsStatic
    {
        get
        {
            return member_context.IsStatic;
        }
    }
