...
public class State  				// state of finite automaton
{
    ...
    public void AddAction(Action act)
    {
        ...
        act.next = a;
        if (a==firstAction) firstAction = act;
        else lasta.next = act;
    }
    ...
    public void DetachAction(Action act)
    {
        ...
        if (a != null)
            if (a == firstAction) firstAction = a.next;
...
public class Action  			// action of finite automaton
{
    ...
    public void GetTargetStates(out BitArray targets, out Symbol endOf, out bool ctx)
    {
        ...
        targets = new BitArray(DFA.maxStates);
        endOf = null;
        ctx = false;
    ...
    public static void PrintStates()
    {
        ...
        for (State state = firstState; state != null; state = state.next)
        {
            ...
            for (Action action = state.firstAction; action != null; action = action.next)
            {
                ...
                if (action.tc == Node.contextTrans) Trace.WriteLine(" context");
