...
public class VersionInfo
{
    ...
    public bool IsVersioned
    {
        get
        {
            return (status & VersionStatus.Versioned) != 0;
        }
    }
    ...
    public bool HasLocalChanges
    {
        get
        {
            return (status & VersionStatus.LocalChangesMask) != 0;
        }
    }
    ...
    public bool HasRemoteChanges
    {
        get
        {
            return (remoteStatus & VersionStatus.LocalChangesMask) != 0;
        }
    }
    ...
    public bool CanAdd
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Add);
        }
    }
    ...
    public bool CanAnnotate
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Annotate);
        }
    }
    ...
    public bool CanCommit
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Commit);
        }
    }
    ...
    public bool CanLock
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Lock);
        }
    }
    ...
    public bool CanLog
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Log);
        }
    }
    ...
    public bool CanRemove
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Remove);
        }
    }
    ...
    public bool CanRevert
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Revert);
        }
    }
    ...
    public bool CanUnlock
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Unlock);
        }
    }
    ...
    public bool CanUpdate
    {
        get
        {
            return SupportsOperation (VersionControlOperation.Update);
        }
    }
}
}
