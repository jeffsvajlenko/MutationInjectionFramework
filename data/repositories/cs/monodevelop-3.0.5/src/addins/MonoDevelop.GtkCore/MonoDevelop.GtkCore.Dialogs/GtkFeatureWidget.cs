...
class GtkFeatureWidget : Gtk.VBox
{
    ...
    public string SelectedVersion
    {
        get
        {
            return versionCombo.ActiveText;
        }
    }
}
...
class GtkProjectFeature: ISolutionItemFeature
{
    public string Title
    {
        get
        {
            return GettextCatalog.GetString ("GTK# Support");
        }
    }
    ...
    public string Description
    {
        get
        {
            return GettextCatalog.GetString ("Enables support for GTK# in the project. Allows the visual design of GTK# windows, and the creation of a GTK# widget library.");
        }
    }
