...
internal class ApplicationBackend: MarshalByRefObject, IDisposable, IObjectViewer
{
    ...
    public AssemblyResolverCallback WidgetLibraryResolver
    {
        get
        {
            return widgetLibraryResolver;
        }
        set
        {
            widgetLibraryResolver = value;
        }
    }
    ...
    public MimeResolverDelegate MimeResolver
    {
        set
        {
            ResourceInfo.MimeResolver = value;
        }
    }
    ...
    public Editor.ShowUrlDelegate ShowUrl
    {
        set
        {
            Editor.NonContainerWarningDialog.ShowUrl = value;
        }
    }
    ...
    public bool ShowNonContainerWarning
    {
        get
        {
            return Wrapper.Container.ShowNonContainerWarning;
        }
        set
        {
            Wrapper.Container.ShowNonContainerWarning = value;
        }
    }
    ...
    public ArrayList GlobalWidgetLibraries
    {
        get
        {
            return globalWidgetLibraries;
        }
        set
        {
            globalWidgetLibraries = value;
        }
    }
