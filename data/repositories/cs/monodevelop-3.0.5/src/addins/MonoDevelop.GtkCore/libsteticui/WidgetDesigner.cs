...
public class WidgetDesigner: Designer
{
    ...
    public override ProjectItemInfo ProjectItem
    {
        get
        {
            return project.GetWidget (rootWidget.Name);
        }
    }
    ...
    public bool Modified
    {
        get
        {
            return session != null && session.Modified;
        }
    }
    ...
    public bool AllowWidgetBinding
    {
        get
        {
            return session != null && session.AllowWidgetBinding;
        }
        set
        {
            if (session != null)
    ...
    public ImportFileDelegate ImportFileCallback
    {
        get
        {
            return editedProject.ImportFileCallback;
        }
        set
        {
            editedProject.ImportFileCallback = value;
        }
    }
...
internal class WidgetDesignerFrontend: MarshalByRefObject
{
    ...
    public void NotifyBindField ()
    {
        GuiDispatch.InvokeSync (
            delegate
        {
            if (!disposed) designer.NotifyBindField ();
        }
        );
    }
    ...
    public void NotifyModifiedChanged ()
    {
        GuiDispatch.InvokeSync (
            delegate
        {
            if (!disposed) designer.NotifyModifiedChanged ();
        }
        );
    }
    ...
    public void NotifyChanged ()
    {
        GuiDispatch.InvokeSync (
            delegate
        {
            if (!disposed) designer.NotifyChanged ();
        }
        );
    }
    ...
    internal void NotifySelectionChanged (object ob, bool canCut, bool canCopy, bool canPaste, bool canDelete)
    {
        GuiDispatch.InvokeSync (
            delegate
        {
            if (!disposed) designer.NotifySelectionChanged (ob, canCut, canCopy, canPaste, canDelete);
        }
        );
    }
    ...
    public void NotifyRootWidgetChanged ()
    {
        GuiDispatch.InvokeSync (
            delegate
        {
            if (!disposed) designer.NotifyRootWidgetChanged ();
        }
        );
    }
    ...
    public void NotifyRootWidgetChanging ()
    {
        GuiDispatch.InvokeSync (
            delegate
        {
            if (!disposed) designer.NotifyRootWidgetChanging ();
        }
        );
    }
