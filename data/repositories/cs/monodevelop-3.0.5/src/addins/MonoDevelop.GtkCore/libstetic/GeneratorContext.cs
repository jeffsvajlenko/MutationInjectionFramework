...
public class GenerationOptions
{
    ...
    public bool GenerateEmptyBuildMethod
    {
        get
        {
            return generateEmptyBuildMethod;
        }
        set
        {
            generateEmptyBuildMethod = value;
        }
    }
    ...
    public bool FailForUnknownWidgets
    {
        get
        {
            return failForUnknownWidgets;
        }
        set
        {
            failForUnknownWidgets = value;
        }
    }

    public bool GenerateModifiedOnly
    {
        get;
        set;
    }
