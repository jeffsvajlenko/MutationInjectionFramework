...
public class Window : Container
{
    ...
    public bool DestroyWithParent
    {
        ...
        set
        {
            destroyWithParent = value;
            EmitNotify ("DestroyWithParent");
        }
    }
    ...
    public bool SkipPagerHint
    {
        get
        {
            return skipPagerHint;
        }
        set
        {
            skipPagerHint = value;
            EmitNotify ("SkipPagerHint");
        }
    }
