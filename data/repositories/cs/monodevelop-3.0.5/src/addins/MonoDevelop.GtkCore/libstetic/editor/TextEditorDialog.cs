...
public class TextEditorDialog: IDisposable
{
    ...
    public string ContextHint
    {
        get
        {
            return entryContext.Text;
        }
        set
        {
            entryContext.Text = value != null ? value : "";
        }
    }
    ...
    public string Comment
    {
        get
        {
            return entryComment.Text;
        }
        set
        {
            entryComment.Text = value != null ? value : "";
        }
    }
    ...
    public bool Translated
    {
        get
        {
            return checkTranslatable.Active;
        }
        set
        {
            checkTranslatable.Active = value;
        }
    }
