...
class ProjectFileWrapper: CustomDescriptor
{
    ...
    public string RelativeDeployPath
    {
        get
        {
            return props.RelativeDeployPath;
        }
        set
        {
            props.RelativeDeployPath = value;
        }
    }
    ...
    public bool HasPathReferences
    {
        get
        {
            return props.HasPathReferences;
        }
        set
        {
            props.HasPathReferences = value;
        }
    }
    ...
    public bool UseProjectRelativePath
    {
        get
        {
            return props.UseProjectRelativePath;
        }
        set
        {
            props.UseProjectRelativePath = value;
        }
    }
    ...
    public DeployFileAttributes FileAttributes
    {
        get
        {
            return props.FileAttributes;
        }
        set
        {
            props.FileAttributes = value;
        }
    }
    ...
    public bool ShouldDeploy
    {
        get
        {
            return props.ShouldDeploy;
        }
        set
        {
            props.ShouldDeploy = value;
        }
    }
