...
internal partial class DeployDialog : Gtk.Dialog
{
    ...
    public bool CreateNewProject
    {
        get
        {
            return radioCreateProject.Active;
        }
    }
    ...
    public SolutionFolder NewProjectSolution
    {
        get
        {
            return CreateNewProject ? combineList [comboCreateProject.Active] as SolutionFolder : null;
        }
    }
    ...
    public PackagingProject ExistingPackagingProject
    {
        get
        {
            return CreateNewProject ? null : projectsList [comboSelProject.Active] as PackagingProject;
        }
    }
