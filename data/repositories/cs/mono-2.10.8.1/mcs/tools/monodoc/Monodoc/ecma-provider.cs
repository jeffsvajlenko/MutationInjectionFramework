...
public class EcmaHelpSource : HelpSource
{
    ...
    public override string InlineCss
    {
        get
        {
            return base.InlineCss + css_ecma_code;
        }
    }
    ...
    public override string InlineJavaScript
    {
        get
        {
            return js_code + base.InlineJavaScript;
        }
    }
    ...
    public class ExtensionObject
    {
        ...
        public string MakeNiceSignature(string sig, string contexttype)
        {
            ...
            case 'N':
                return sig;
            case 'T':
                return ShortTypeName(sig, contexttype);
            ...
            try
            {
                ...
                foreach (MemberInfo mi in mis)
                {
                    ...
                    if (pis != null)
                    {
                        ...
                        {
                            if (pis[i].ParameterType.FullName != (string)arglist[i])
                            {
                                good = false;
                                break;
                            }
