...
public class UnaryMutator : ExpressionStatement
{
    ...
    bool IsDecrement
    {
        get
        {
            return (mode & Mode.IsDecrement) != 0;
        }
    }
...
public abstract class VariableReference : Expression, IAssignMethod, IMemoryLocation, IVariableReference
{
    ...
    public bool IsHoisted
    {
        get
        {
            return GetHoistedVariable ((AnonymousExpression) null) != null;
        }
    }
}
...
public class LocalVariableReference : VariableReference
{
    ...
    public override Expression DoResolveLValue (ResolveContext ec, Expression right_side)
    {
        ...
        if (local_info.IsReadonly && !ec.HasAny (ResolveContext.Options.FieldInitializerScope | ResolveContext.Options.UsingInitializerScope))
        {
            ...
            {
                code = 1654;
                msg = "Cannot assign to members of `{0}' because it is a `{1}'";
            }
            else if (right_side == EmptyExpression.LValueMemberOutAccess)
            {
                code = 1655;
                msg = "Cannot pass members of `{0}' as ref or out arguments because it is a `{1}'";
            }
...
public class ParameterReference : VariableReference
{
    ...
    public override bool IsRef
    {
        get
        {
            return (pi.Parameter.ModFlags & Parameter.Modifier.ISBYREF) != 0;
        }
    }
    ...
    bool HasOutModifier
    {
        get
        {
            return pi.Parameter.ModFlags == Parameter.Modifier.OUT;
        }
    }
...
abstract class TypeOfMember<T> : Expression where T : MemberSpec
{
    ...
    protected abstract MethodSpec TypeFromHandle
    {
        get;
        set;
    }
    protected abstract MethodSpec TypeFromHandleGeneric
    {
        get;
        set;
    }
