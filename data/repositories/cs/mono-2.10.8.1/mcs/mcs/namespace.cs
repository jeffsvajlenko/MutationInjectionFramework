...
public class NamespaceEntry : IMemberContext
{
    ...
    public TypeSpec CurrentType
    {
        get
        {
            return SlaveDeclSpace.CurrentType;
        }
    }
    ...
    public MemberCore CurrentMemberDefinition
    {
        get
        {
            return SlaveDeclSpace.CurrentMemberDefinition;
        }
    }
    ...
    public TypeParameter[] CurrentTypeParameters
    {
        get
        {
            return SlaveDeclSpace.CurrentTypeParameters;
        }
    }
    ...
    public bool IsObsolete
    {
        get
        {
            return SlaveDeclSpace.IsObsolete;
        }
    }
    ...
    public bool IsUnsafe
    {
        get
        {
            return SlaveDeclSpace.IsUnsafe;
        }
    }
    ...
    public bool IsStatic
    {
        get
        {
            return SlaveDeclSpace.IsStatic;
        }
    }
