...
public interface IMemberContext
{
    ...
    //
    TypeParameter[] CurrentTypeParameters
    {
        get;
    }
...
//					ec.Report.EnableReporting ();
    ...
    public Iterator CurrentIterator
    {
        get
        {
            return CurrentAnonymousMethod as Iterator;
        }
    }
    ...
    public TypeSpec CurrentType
    {
        get
        {
            return MemberContext.CurrentType;
        }
    }
    ...
    public TypeParameter[] CurrentTypeParameters
    {
        get
        {
            return MemberContext.CurrentTypeParameters;
        }
    }
    ...
    public MemberCore CurrentMemberDefinition
    {
        get
        {
            return MemberContext.CurrentMemberDefinition;
        }
    }
    ...
    public bool ConstantCheckState
    {
        get
        {
            return (flags & Options.ConstantCheckState) != 0;
        }
    }
    ...
    public bool DoFlowAnalysis
    {
        get
        {
            return (flags & Options.DoFlowAnalysis) != 0;
        }
    }
    ...
    public bool OmitStructFlowAnalysis
    {
        get
        {
            return (flags & Options.OmitStructFlowAnalysis) != 0;
        }
    }
