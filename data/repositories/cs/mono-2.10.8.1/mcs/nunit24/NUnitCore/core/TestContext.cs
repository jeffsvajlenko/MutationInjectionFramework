...
public class TestContext : IDisposable
{
    ...
    public static bool Tracing
    {
        get
        {
            return current.Tracing;
        }
        set
        {
            current.Tracing = value;
        }
    }
    ...
    public static TextWriter TraceWriter
    {
        get
        {
            return current.TraceWriter;
        }
        set
        {
            current.TraceWriter = value;
        }
    }
    ...
    public static string CurrentDirectory
    {
        get
        {
            return current.CurrentDirectory;
        }
        set
        {
            current.CurrentDirectory = value;
        }
    }
    ...
    public static CultureInfo CurrentCulture
    {
        get
        {
            return current.CurrentCulture;
        }
        set
        {
            current.CurrentCulture = value;
        }
    }
    ...
    private class ContextHolder
    {
        ...
        public TextWriter LogWriter
        {
            get
            {
                return logCapture.Writer;
            }
            set
            {
                logCapture.Writer = value;
            }
        }
