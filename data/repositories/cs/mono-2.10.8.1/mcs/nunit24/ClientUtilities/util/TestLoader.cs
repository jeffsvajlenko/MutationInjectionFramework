...
public class TestLoader : MarshalByRefObject, NUnit.Core.EventListener, ITestLoader, IService
{
    ...
    public bool Running
    {
        get
        {
            return testRunner != null && testRunner.Running;
        }
    }
    ...
    public string TestFileName
    {
        get
        {
            return testProject.ProjectPath;
        }
    }
    ...
    public bool AutoNamespaceSuites
    {
        get
        {
            return autoNamespaceSuites;
        }
        set
        {
            autoNamespaceSuites = value;
        }
    }
    ...
    public IList AssemblyInfo
    {
        get
        {
            return testRunner == null ? null : testRunner.AssemblyInfo;
        }
    }
    ...
    public int TestCount
    {
        get
        {
            return loadedTest == null ? 0 : loadedTest.TestCount;
        }
    }
    #endregion
