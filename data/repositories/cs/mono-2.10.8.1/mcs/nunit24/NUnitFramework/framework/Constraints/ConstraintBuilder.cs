...
public class ConstraintBuilder
{
    ...
    public Constraint Null
    {
        get
        {
            return Resolve(new EqualConstraint(null));
        }
    }
    ...
    public Constraint True
    {
        get
        {
            return Resolve(new EqualConstraint(true));
        }
    }
    ...
    public Constraint False
    {
        get
        {
            return Resolve(new EqualConstraint(false));
        }
    }
    ...
    public Constraint NaN
    {
        get
        {
            return Resolve(new EqualConstraint(double.NaN));
        }
    }
    ...
    public Constraint Empty
    {
        get
        {
            return Resolve(new EmptyConstraint());
        }
    }
    ...
    public Constraint Unique
    {
        get
        {
            return Resolve(new UniqueItemsConstraint());
        }
    }
    #endregion
