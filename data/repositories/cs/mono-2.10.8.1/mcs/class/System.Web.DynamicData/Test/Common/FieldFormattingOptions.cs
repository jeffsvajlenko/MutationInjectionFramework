...
class FieldFormattingOptions : IFieldFormattingOptions
{
    ...
    public bool ApplyFormatInEditMode
    {
        get
        {
            return GetProperty <bool> ("ApplyFormatInEditMode");
        }
    }
    ...
    public bool ConvertEmptyStringToNull
    {
        get
        {
            return GetProperty <bool> ("ConvertEmptyStringToNull");
        }
    }
    ...
    public string DataFormatString
    {
        get
        {
            return GetProperty <string> ("DataFormatString");
        }
    }
    ...
    public bool HtmlEncode
    {
        get
        {
            return GetProperty <bool> ("HtmlEncode");
        }
    }
    ...
    public string NullDisplayText
    {
        get
        {
            return GetProperty <string> ("NullDisplayText");
        }
    }
