...
public class FormRequest : PostableRequest
{
    ...
    public override bool IsPost
    {
        ...
        set
        {
            throw new Exception ("Must not change IsPost of FormPostback");
        }
    }
    ...
    public override string ContentType
    {
        ...
        set
        {
            throw new Exception ("Must not change PostContentType of FormPostback");
        }
    }
    ...
    public override byte[] EntityBody
    {
        ...
        set
        {
            throw new Exception ("Must not change EntityBody of FormPostback");
        }
    }
