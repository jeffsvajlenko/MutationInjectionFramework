...
internal class WebReferenceOptionsReader : XmlSerializationReader
{
    ...
    System.Web.Services.Description.ServiceDescriptionImportStyle GetEnumValue_ServiceDescriptionImportStyle (string xmlName)
    {
        ...
        case "serverInterface":
            return System.Web.Services.Description.ServiceDescriptionImportStyle.ServerInterface;
        default:
    ...
    System.Xml.Serialization.CodeGenerationOptions GetEnumValue_CodeGenerationOptions_Switch (string xmlName)
    {
        ...
        {
        case "properties":
            return System.Xml.Serialization.CodeGenerationOptions.GenerateProperties;
        case "newAsync":
            return System.Xml.Serialization.CodeGenerationOptions.GenerateNewAsync;
        case "oldAsync":
            return System.Xml.Serialization.CodeGenerationOptions.GenerateOldAsync;
        case "order":
            return System.Xml.Serialization.CodeGenerationOptions.GenerateOrder;
        case "enableDataBinding":
            return System.Xml.Serialization.CodeGenerationOptions.EnableDataBinding;
        default:
...
internal class WebReferenceOptionsWriter : XmlSerializationWriter
{
    ...
    string GetEnumValue_ServiceDescriptionImportStyle (System.Web.Services.Description.ServiceDescriptionImportStyle val)
    {
        ...
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (System.Web.Services.Description.ServiceDescriptionImportStyle).FullName);
        }
    }
