...
public sealed class AssemblyName : ICloneable
{
    ...
    public StrongNameKeyPair KeyPair
    {
        get
        {
            return name.KeyPair == null ?  null : new StrongNameKeyPair(name.KeyPair);
        }
        set
        {
            name.KeyPair = value == null ? null : value.keyPair;
        }
    }
    ...
    public ProcessorArchitecture ProcessorArchitecture
    {
        get
        {
            return (ProcessorArchitecture)name.ProcessorArchitecture;
        }
        set
        {
            name.ProcessorArchitecture = (System.Reflection.ProcessorArchitecture)value;
        }
    }
    ...
    public AssemblyNameFlags Flags
    {
        get
        {
            return (AssemblyNameFlags)name.Flags;
        }
        set
        {
    ...
    public AssemblyVersionCompatibility VersionCompatibility
    {
        get
        {
            return name.VersionCompatibility;
        }
        set
        {
            name.VersionCompatibility = value;
        }
    }
