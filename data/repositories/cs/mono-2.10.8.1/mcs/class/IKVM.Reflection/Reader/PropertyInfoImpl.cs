...
sealed class PropertyInfoImpl : PropertyInfo
{
    ...
    public override PropertyAttributes Attributes
    {
        get
        {
            return (PropertyAttributes)module.Property.records[index].Flags;
        }
    }
    ...
    public override int MetadataToken
    {
        get
        {
            return (PropertyTable.Index << 24) + index + 1;
        }
    }
    ...
    public override string Name
    {
        get
        {
            return module.GetString(module.Property.records[index].Name);
        }
    }
