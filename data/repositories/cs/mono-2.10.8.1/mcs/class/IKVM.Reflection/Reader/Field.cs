...
sealed class FieldDefImpl : FieldInfo
{
    ...
    public override FieldAttributes Attributes
    {
        get
        {
            return (FieldAttributes)module.Field.records[index].Flags;
        }
    }
    ...
    public override string Name
    {
        get
        {
            return module.GetString(module.Field.records[index].Name);
        }
    }
    ...
    public override int MetadataToken
    {
        get
        {
            return (FieldTable.Index << 24) + index + 1;
        }
    }
    ...
    internal override FieldSignature FieldSignature
    {
        get
        {
            return lazyFieldSig ?? (lazyFieldSig = FieldSignature.ReadSig(module, module.GetBlob(module.Field.records[index].Signature), declaringType));
        }
    }
