...
sealed class TypeDefImpl : Type
{
    ...
    public override TypeAttributes Attributes
    {
        get
        {
            return (TypeAttributes)module.TypeDef.records[index].Flags;
        }
    }
    ...
    public override int MetadataToken
    {
        get
        {
            return (TypeDefTable.Index << 24) + index + 1;
        }
    }
    ...
    public override bool IsGenericTypeDefinition
    {
        get
        {
            return module.GenericParam.FindFirstByOwner(this.MetadataToken) != -1;
        }
    }
