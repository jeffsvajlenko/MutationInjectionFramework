...
sealed class GenericTypeParameter : TypeParameterType
{
    ...
    public override string Name
    {
        get
        {
            return module.GetString(module.GenericParam.records[index].Name);
        }
    }
    ...
    public override int MetadataToken
    {
        get
        {
            return (GenericParamTable.Index << 24) + index + 1;
        }
    }
    ...
    public override int GenericParameterPosition
    {
        get
        {
            return module.GenericParam.records[index].Number;
        }
    }
    ...
    public override GenericParameterAttributes GenericParameterAttributes
    {
        get
        {
            return (GenericParameterAttributes)module.GenericParam.records[index].Flags;
        }
    }
