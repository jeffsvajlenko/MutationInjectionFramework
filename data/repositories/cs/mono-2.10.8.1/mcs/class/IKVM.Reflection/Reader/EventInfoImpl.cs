...
sealed class EventInfoImpl : EventInfo
{
    ...
    public override EventAttributes Attributes
    {
        get
        {
            return (EventAttributes)module.Event.records[index].EventFlags;
        }
    }
    ...
    public override Type EventHandlerType
    {
        get
        {
            return module.ResolveType(module.Event.records[index].EventType, declaringType);
        }
    }
    ...
    public override string Name
    {
        get
        {
            return module.GetString(module.Event.records[index].Name);
        }
    }
    ...
    public override int MetadataToken
    {
        get
        {
            return (EventTable.Index << 24) + index + 1;
        }
    }
