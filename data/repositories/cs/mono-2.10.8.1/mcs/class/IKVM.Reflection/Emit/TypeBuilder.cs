...
public sealed class GenericTypeParameterBuilder : Type
{
    ...
    public override bool IsValueType
    {
        get
        {
            return (this.GenericParameterAttributes & GenericParameterAttributes.NotNullableValueTypeConstraint) != 0;
        }
    }
    ...
    private ModuleBuilder ModuleBuilder
    {
        get
        {
            return type != null ? type.ModuleBuilder : method.ModuleBuilder;
        }
    }
...
sealed class BakedType : Type
{
    ...
    public override string AssemblyQualifiedName
    {
        get
        {
            return typeBuilder.AssemblyQualifiedName;
        }
    }
    ...
    public override string Namespace
    {
        get
        {
            return typeBuilder.GetBakedNamespace();
        }
    }
    ...
    public override StructLayoutAttribute StructLayoutAttribute
    {
        get
        {
            return typeBuilder.StructLayoutAttribute;
        }
    }
    ...
    public override int MetadataToken
    {
        get
        {
            return typeBuilder.MetadataToken;
        }
    }
