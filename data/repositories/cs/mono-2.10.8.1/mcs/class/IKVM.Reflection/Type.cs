...
public abstract class Type : MemberInfo, IGenericContext, IGenericBinder
{
    ...
    public ConstructorInfo TypeInitializer
    {
        get
        {
            return GetConstructor(BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic, null, Type.EmptyTypes, null);
        }
    }
    ...
    public bool IsEnum
    {
        get
        {
            return this.BaseType == this.Module.universe.System_Enum;
        }
    }
    ...
    public bool IsContextful
    {
        get
        {
            return IsSubclassOf(this.Module.universe.Import(typeof(ContextBoundObject)));
        }
    }
    ...
    public bool IsMarshalByRef
    {
        get
        {
            return IsSubclassOf(this.Module.universe.Import(typeof(MarshalByRefObject)));
        }
    }
...
abstract class ElementHolderType : Type
{
    ...
    public sealed override string Name
    {
        get
        {
            return elementType.Name + GetSuffix();
        }
    }
    ...
    public sealed override string FullName
    {
        get
        {
            return elementType.FullName + GetSuffix();
        }
    }
...
sealed class ArrayType : ElementHolderType
{
    ...
    public override Type BaseType
    {
        get
        {
            return elementType.Module.universe.System_Array;
        }
    }
...
sealed class BuiltinArrayMethod : ArrayMethod
{
    ...
    public override MethodAttributes Attributes
    {
        get
        {
            return this.Name == ".ctor" ? MethodAttributes.RTSpecialName | MethodAttributes.Public : MethodAttributes.Public;
        }
    }
    ...
    public override ParameterInfo ReturnParameter
    {
        get
        {
            return new ParameterInfoImpl(this, this.ReturnType, -1);
        }
    }
    ...
    private sealed class ParameterInfoImpl : ParameterInfo
    {
        ...
        public override MemberInfo Member
        {
            get
            {
                return method.IsConstructor ? (MethodBase)new ConstructorInfoImpl(method) : method;
            }
        }
