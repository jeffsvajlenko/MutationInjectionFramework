    ...
    XmlDictionaryReader, IXmlLineInfo, IXmlNamespaceResolver
{
    ...
    public int LineNumber
    {
        get
        {
            return as_line_info != null ? as_line_info.LineNumber : 0;
        }
    }
    ...
    public int LinePosition
    {
        get
        {
            return as_line_info != null ? as_line_info.LinePosition : 0;
        }
    }
    ...
    public override bool CanCanonicalize
    {
        get
        {
            return as_dict_reader != null ? as_dict_reader.CanCanonicalize : false;
        }
    }
