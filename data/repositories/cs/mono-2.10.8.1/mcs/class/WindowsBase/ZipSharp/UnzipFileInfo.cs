...
struct UnzipFileInfo
{
    ...
    public ulong VersionNeeded
    {
        get
        {
            return (ulong)version_needed.ToInt64 ();
        }
        set
        {
            version_needed = new IntPtr ((int)value);
        }
    }
    ...
    public ulong Version
    {
        get
        {
            return (ulong)version.ToInt64 ();
        }
        set
        {
            version = new IntPtr ((int)value);
        }
    }
    ...
    public ulong UncompressedSize
    {
        get
        {
            return (ulong)uncompressed_size.ToInt64 ();
        }
        set
        {
            uncompressed_size = new IntPtr ((int)value);
        }
    }
    ...
    public ulong SizeFilename
    {
        get
        {
            return (ulong)size_filename.ToInt64 ();
        }
        set
        {
            size_filename = new IntPtr ((int)value);
        }
    }
    ...
    public ulong SizeFileExtra
    {
        get
        {
            return (ulong)size_file_extra.ToInt64 ();
        }
        set
        {
            size_file_extra = new IntPtr ((int)value);
        }
    }
    ...
    public ulong InternalFa
    {
        get
        {
            return (ulong)internal_fa.ToInt64 ();
        }
        set
        {
            internal_fa = new IntPtr ((int)value);
        }
    }
    ...
    public ulong Flag
    {
        get
        {
            return (ulong)flag.ToInt64 ();
        }
        set
        {
            flag = new IntPtr ((int)value);
        }
    }
    ...
    public ulong ExternalFa
    {
        get
        {
            return (ulong)external_fa.ToInt64 ();
        }
        set
        {
            external_fa = new IntPtr ((int)value);
        }
    }
    ...
    public ulong DosDate
    {
        get
        {
            return (ulong)dosDate.ToInt64 ();
        }
        set
        {
            dosDate = new IntPtr ((int)value);
        }
    }
    ...
    public ulong DiskNumStart
    {
        get
        {
            return (ulong)disk_num_start.ToInt64 ();
        }
        set
        {
            disk_num_start = new IntPtr ((int)value);
        }
    }
    ...
    public ulong Crc
    {
        get
        {
            return (ulong)crc.ToInt64 ();
        }
        set
        {
            crc = new IntPtr ((int)value);
        }
    }
    ...
    public ulong CompressionMethod
    {
        get
        {
            return (ulong)compression_method.ToInt64 ();
        }
        set
        {
            compression_method = new IntPtr ((int)value);
        }
    }
    ...
    public ulong CompressedSize
    {
        get
        {
            return (ulong)compressed_size.ToInt64 ();
        }
        set
        {
            compressed_size = new IntPtr ((int)value);
        }
    }
}
}
