...
class GeneratedWriter : XmlSerializationWriter
{
    ...
    string GetEnumValue_AccessModifier (DbLinq.Schema.Dbml.AccessModifier val)
    {
        ...
        case DbLinq.Schema.Dbml.AccessModifier.Private:
            return "Private";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.AccessModifier).FullName);
        }
    }
    ...
    string GetEnumValue_ClassModifier (DbLinq.Schema.Dbml.ClassModifier val)
    {
        ...
        case DbLinq.Schema.Dbml.ClassModifier.Abstract:
            return "Abstract";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.ClassModifier).FullName);
        }
    }
    ...
    string GetEnumValue_SerializationMode (DbLinq.Schema.Dbml.SerializationMode val)
    {
        ...
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.SerializationMode).FullName);
        }
    }
    ...
    string GetEnumValue_ConnectionMode (DbLinq.Schema.Dbml.ConnectionMode val)
    {
        ...
        case DbLinq.Schema.Dbml.ConnectionMode.WebSettings:
            return "WebSettings";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.ConnectionMode).FullName);
        }
    }
    ...
    string GetEnumValue_MemberModifier (DbLinq.Schema.Dbml.MemberModifier val)
    {
        ...
        case DbLinq.Schema.Dbml.MemberModifier.NewVirtual:
            return "NewVirtual";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.MemberModifier).FullName);
        }
    }
    ...
    string GetEnumValue_ParameterDirection (DbLinq.Schema.Dbml.ParameterDirection val)
    {
        ...
        case DbLinq.Schema.Dbml.ParameterDirection.InOut:
            return "InOut";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.ParameterDirection).FullName);
        }
    }
    ...
    string GetEnumValue_UpdateCheck (DbLinq.Schema.Dbml.UpdateCheck val)
    {
        ...
        case DbLinq.Schema.Dbml.UpdateCheck.WhenChanged:
            return "WhenChanged";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.UpdateCheck).FullName);
        }
    }
    ...
    string GetEnumValue_AutoSync (DbLinq.Schema.Dbml.AutoSync val)
    {
        ...
        case DbLinq.Schema.Dbml.AutoSync.Default:
            return "Default";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.AutoSync).FullName);
        }
    }
    ...
    string GetEnumValue_Cardinality (DbLinq.Schema.Dbml.Cardinality val)
    {
        ...
        case DbLinq.Schema.Dbml.Cardinality.Many:
            return "Many";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.Cardinality).FullName);
        }
    }
    ...
    string GetEnumValue_Version (DbLinq.Schema.Dbml.Version val)
    {
        ...
        case DbLinq.Schema.Dbml.Version.Original:
            return "Original";
        default:
            throw CreateInvalidEnumValueException ((long) val, typeof (DbLinq.Schema.Dbml.Version).FullName);
        }
    }
