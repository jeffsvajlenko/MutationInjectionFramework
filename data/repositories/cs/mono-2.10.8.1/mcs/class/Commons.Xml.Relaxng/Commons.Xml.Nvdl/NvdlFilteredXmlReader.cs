...
internal class NvdlFilteredXmlReader : XmlReader, IXmlLineInfo
{
    ...
    public int LineNumber
    {
        get
        {
            return reader_as_line_info != null ? reader_as_line_info.LineNumber : 0;
        }
    }
    ...
    public int LinePosition
    {
        get
        {
            return reader_as_line_info != null ? reader_as_line_info.LinePosition : 0;
        }
    }
    ...
    public override bool EOF
    {
        get
        {
            return reader.EOF && placeHolder != XmlNodeType.None;
        }
    }
