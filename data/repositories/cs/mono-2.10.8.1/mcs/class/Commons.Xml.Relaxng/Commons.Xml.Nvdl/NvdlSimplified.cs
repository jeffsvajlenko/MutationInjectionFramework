...
internal class SimplifiedItem : IXmlLineInfo
{
    ...
    public string SourceUri
    {
        ...
        set
        {
            sourceUri = value != null ? value : String.Empty;
        }
    }
    ...
    public string Location
    {
        get
        {
            return line != 0 ? String.Format ("{0} ({1},{2})", sourceUri, line, column) : String.Empty;
        }
    }
}
