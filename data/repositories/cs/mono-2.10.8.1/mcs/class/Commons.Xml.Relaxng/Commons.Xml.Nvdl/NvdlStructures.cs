...
//		[Map.Attribute]
    public string SchemaType
    {
        ...
        set
        {
            schemaType = value != null ? value.Trim (Nvdl.Whitespaces) : null;
        }
    }
...
//		[MapType ("NCName", XmlSchema.Namespace)]
    public string StartMode
    {
        ...
        set
        {
            startMode = value != null ? value.Trim (Nvdl.Whitespaces) : null;
        }
    }
...
//		[Map.List]
    public string NameList
    {
        ...
        set
        {
            nameList = value != null ? value.Trim (Nvdl.Whitespaces) : null;
        }
    }
}
...
//		[MapType ("NCName", XmlSchema.Namespace)]
    public string Name
    {
        ...
        set
        {
            name = value != null ? value.Trim (Nvdl.Whitespaces) : null;
        }
    }
}
...
{
    public abstract NvdlResultType ResultType
    {
        get;
    }
}
...
public class NvdlAttachPlaceholder : NvdlResultAction
{
    public override NvdlResultType ResultType
    {
        get
        {
            return NvdlResultType.AttachPlaceholder;
        }
    }
}
...
public class NvdlOption : NvdlAttributable
{
    ...
    public string MustSupport
    {
        ...
        set
        {
            mustSupport = value != null ? value.Trim (Nvdl.Whitespaces) : null;
        }
    }
}
...
public class NvdlModeUsage
{
    ...
    public string UseMode
    {
        ...
        set
        {
            useMode = value != null ? value.Trim (Nvdl.Whitespaces) : null;
        }
    }
...
public class NvdlTriggerList : CollectionBase
{
    public NvdlTrigger this [int i]
    {
        get
        {
            return (NvdlTrigger) List [i];
        }
        set
        {
            List [i] = (NvdlTrigger) value;
        }
    }
...
public class NvdlRuleList : CollectionBase
{
    public NvdlRule this [int i]
    {
        get
        {
            return (NvdlRule) List [i];
        }
        set
        {
            List [i] = (NvdlRule) value;
        }
    }
...
public class NvdlModeList : CollectionBase
{
    public NvdlModeBase this [int i]
    {
        get
        {
            return (NvdlModeBase) List [i];
        }
        set
        {
            List [i] = (NvdlModeBase) value;
        }
    }
...
public class NvdlContextList : CollectionBase
{
    public NvdlContext this [int i]
    {
        get
        {
            return (NvdlContext) List [i];
        }
        set
        {
            List [i] = (NvdlContext) value;
        }
    }
...
public class NvdlActionList : CollectionBase
{
    public NvdlAction this [int i]
    {
        get
        {
            return (NvdlAction) List [i];
        }
        set
        {
            List [i] = (NvdlAction) value;
        }
    }
...
public class NvdlOptionList : CollectionBase
{
    public NvdlOption this [int i]
    {
        get
        {
            return (NvdlOption) List [i];
        }
        set
        {
            List [i] = (NvdlOption) value;
        }
    }
...
public class NvdlMessageList : CollectionBase
{
    public NvdlMessage this [int i]
    {
        get
        {
            return (NvdlMessage) List [i];
        }
        set
        {
            List [i] = (NvdlMessage) value;
        }
    }
