...
public class FilterTableEntryElement : ConfigurationElement
{
    ...
    public string BackupList
    {
        get
        {
            return (string) base ["backupList"];
        }
        set
        {
            base ["backupList"] = value;
        }
    }
    ...
    public string EndpointName
    {
        get
        {
            return (string) base ["endpointName"];
        }
        set
        {
            base ["endpointName"] = value;
        }
    }
    ...
    public string FilterName
    {
        get
        {
            return (string) base ["filterName"];
        }
        set
        {
            base ["filterName"] = value;
        }
    }
