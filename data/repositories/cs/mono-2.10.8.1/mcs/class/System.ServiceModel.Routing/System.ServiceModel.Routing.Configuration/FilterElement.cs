...
public class FilterElement : ConfigurationElement
{
    ...
    public string CustomType
    {
        get
        {
            return (string) base ["customType"];
        }
        set
        {
            base ["customType"] = value;
        }
    }
    ...
    public string FilterData
    {
        get
        {
            return (string) base ["filterData"];
        }
        set
        {
            base ["filterData"] = value;
        }
    }
    ...
    public FilterType FilterType
    {
        get
        {
            return (FilterType) base ["filterType"];
        }
        set
        {
