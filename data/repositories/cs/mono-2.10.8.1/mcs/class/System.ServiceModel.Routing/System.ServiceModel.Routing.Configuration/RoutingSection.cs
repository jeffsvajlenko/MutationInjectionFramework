...
public class RoutingSection : ConfigurationSection
{
    ...
    public BackupListCollection BackupLists
    {
        get
        {
            return (BackupListCollection) base ["backupLists"];
        }
        private set
        {
            base ["backupLists"] = value;
        }
    }
    ...
    public FilterTableCollection FilterTables
    {
        get
        {
            return (FilterTableCollection) base ["filterTables"];
        }
        private set
        {
            base ["filterTables"] = value;
        }
    }
    ...
    public NamespaceElementCollection NamespaceTable
    {
        get
        {
            return (NamespaceElementCollection) base ["namespaceTable"];
        }
        private set
        {
            base ["namespaceTable"] = value;
        }
    }
}
}
