...
public class MethodDef : ICustomAttrTarget, IDeclSecurityTarget
{
    ...
    public bool IsVararg
    {
        get
        {
            return (call_conv & PEAPI.CallConv.Vararg) != 0;
        }
    }
    ...
    public bool IsStatic
    {
        get
        {
            return (meth_attr & PEAPI.MethAttr.Static) != 0;
        }
    }
    ...
    public bool IsVirtual
    {
        get
        {
            return (meth_attr & PEAPI.MethAttr.Virtual) != 0;
        }
    }
    ...
    public bool IsAbstract
    {
        get
        {
            return (meth_attr & PEAPI.MethAttr.Abstract) != 0;
        }
    }
    ...
    public int GenParamCount
    {
        get
        {
            return (gen_params != null ? gen_params.Count : 0);
        }
    }
