...
public class TypeDef : ICustomAttrTarget, IDeclSecurityTarget, IComparable
{
    ...
    public string NestedFullName
    {
        get
        {
            return (outer == null ? FullName : (outer.NestedFullName + "/" + FullName));
        }
    }
    ...
    public bool IsInterface
    {
        get
        {
            return (attr & PEAPI.TypeAttr.Interface) != 0;
        }
    }
    ...
    public bool IsAbstract
    {
        get
        {
            return (attr & PEAPI.TypeAttr.Abstract) != 0;
        }
    }
