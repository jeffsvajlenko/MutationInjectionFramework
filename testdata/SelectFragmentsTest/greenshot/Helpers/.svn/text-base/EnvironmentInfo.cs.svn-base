...
public class EnvironmentInfo
{
    ...
    public static string OSName
    {
        get
        {
            switch (OSVersion)
            {
            case OSVersionEnum.Win95:
                return "Windows 95";
            case OSVersionEnum.Win98:
                return "Windows 98";
            case OSVersionEnum.WinME:
                return "Windows ME";
            case OSVersionEnum.WinNT4:
                return "Windows NT 4";
            case OSVersionEnum.Win2000:
                return "Windows 2000";
            case OSVersionEnum.WinXP:
                return "Windows XP" + (Is64Bit ? " x64" : "");
            case OSVersionEnum.Win2003:
                return "Windows Server 2003" + (Is64Bit ? " x64" : "");
            case OSVersionEnum.WinVista:
                return "Windows Vista" + (Is64Bit ? " x64" : "");
            }
            return "";
        }
    }
