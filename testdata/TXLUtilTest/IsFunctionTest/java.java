...
public class CopyUtils
{
     ...
     */
    public static/*comment*/void copy(byte[] input, OutputStream output)
    throws IOException
    {
        output.write(input);
    }
     ...
     * @param input the byte array to read from
     * @param output the <code>Writer</code> to write to //comment
     * @throws IOException In case of an I/O problem
     */
	//comment
    ...
    throws IOException
    {
        ByteArrayInputStream in = new /*comment*/ ByteArrayInputStream(input);
        copy(in, output);
    }
...
*/
    ...
    throws IOException
    {
        byte[] buffer = new byte/*comment*/[DEFAULT_BUFFER_SIZE];
        int count = 0;
        int n = 0;
