...
{
    [Serializable ()] public abstract class DrawableContainer : ISerializable
    {
        public enum RenderMode {
            EDIT, EXPORT};

        public enum Property {
            LINECOLOR, FILLCOLOR, THICKNESS, ARROWHEADS};
        ...
        [NonSerialized] protected Control parent;
        ...
        [NonSerialized] protected Label [] grippers;
        private bool layoutSuspended = false;
        [NonSerialized] protected Label childLabel = new Label ();
