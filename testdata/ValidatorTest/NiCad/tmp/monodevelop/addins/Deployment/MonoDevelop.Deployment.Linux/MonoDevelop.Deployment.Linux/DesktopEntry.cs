...
public class DesktopEntry
{
    ...
    public string GenericName
    {
        get
        {
            return GetEntry ("GenericName", true);
        }
        set
        {
            SetEntry ("GenericName", value, true);
        }
    }
    ...
    public bool NoDisplay
    {
        get
        {
            return GetBoolEntry ("NoDisplay");
        }
        set
        {
            SetBoolEntry ("NoDisplay", value);
        }
    }
    ...
    public string Comment
    {
        get
        {
            return GetEntry ("Comment", true);
        }
        set
        {
            SetEntry ("Comment", value, true);
        }
    }
    ...
    public string Icon
    {
        get
        {
            return GetEntry ("Icon", true);
        }
        set
        {
            SetEntry ("Icon", value, true);
        }
    }
    ...
    public StringCollection OnlyShowIn
    {
        get
        {
            return GetStringsEntry ("OnlyShowIn");
        }
    }
    ...
    public StringCollection NotShowIn
    {
        get
        {
            return GetStringsEntry ("NotShowIn");
        }
    }
    ...
    public string TryExec
    {
        get
        {
            return GetEntry ("TryExec");
        }
        set
        {
            SetEntry ("TryExec", value);
        }
    }
    ...
    public bool Terminal
    {
        get
        {
            return GetBoolEntry ("Terminal");
        }
        set
        {
            SetBoolEntry ("Terminal", value);
        }
    }
    ...
    public StringCollection MimeTypes
    {
        get
        {
            return GetStringsEntry ("MimeType");
        }
    }
    ...
    public StringCollection Categories
    {
        get
        {
            return GetStringsEntry ("Categories");
        }
    }
