...
public class ActionGroupDesigner: Designer
{
    ...
    public override ProjectItemInfo ProjectItem
    {
        get
        {
            return project.GetWidget (RootComponent.Name);
        }
    }
    ...
    public Component RootComponent
    {
        get
        {
            return app.GetComponent (editSession.EditedActionGroup, null, null);
        }
    }
    ...
    public bool HasData
    {
        get
        {
            return editSession != null && editSession.HasData;
        }
    }
    ...
    public bool Modified
    {
        get
        {
            return editSession != null && editSession.Modified;
        }
        set
        {
            if (editSession != null)
...
internal class ActionGroupDesignerFrontend: MarshalByRefObject
{
    ...
    public void NotifyModified ()
    {
        Gtk.Application.Invoke (
            delegate
        {
            if (!disposed) designer.NotifyModified ();
        }
        );
    }
    ...
    public void NotifySignalAdded (Wrapper.Action action, string name, Signal signal)
    {
        Gtk.Application.Invoke (
            delegate
        {
            if (!disposed) designer.NotifySignalAdded (action, name, signal);
        }
        );
    }
    ...
    public void NotifySignalChanged (Wrapper.Action action, string name, Signal oldSignal, Signal signal)
    {
        Gtk.Application.Invoke (
            delegate
        {
            if (!disposed) designer.NotifySignalChanged (action, name, oldSignal, signal);
        }
        );
    }
