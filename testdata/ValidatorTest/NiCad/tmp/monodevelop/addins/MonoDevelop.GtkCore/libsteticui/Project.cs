...
public class Project: MarshalByRefObject
{
    ...
    public Stetic.ProjectIconFactory IconFactory
    {
        get
        {
            return ProjectBackend.IconFactory;
        }
        set
        {
    ...
    public ImportFileDelegate ImportFileCallback
    {
        get
        {
            return importFileDelegate;
        }
        set
        {
            importFileDelegate = value;
        }
    }
    ...
    public bool CanGenerateCode
    {
        get
        {
            return ProjectBackend.CanGenerateCode;
        }
    }
    ...
    public string ImagesRootPath
    {
        get
        {
            return ProjectBackend.ImagesRootPath;
        }
        set
        {
            ProjectBackend.ImagesRootPath = value;
        }
    }
    ...
    public string TargetGtkVersion
    {
        get
        {
            return ProjectBackend.TargetGtkVersion;
        }
        set
        {
            ProjectBackend.TargetGtkVersion = value;
        }
    }
...
public class WidgetInfo: ProjectItemInfo
{
    ...
    public bool IsWindow
    {
        get
        {
            return type == "Gtk.Dialog" || type == "Gtk.Window";
        }
    }
    ...
    public override Component Component
    {
        get
        {
            return project.GetComponent (Name);
        }
    }
