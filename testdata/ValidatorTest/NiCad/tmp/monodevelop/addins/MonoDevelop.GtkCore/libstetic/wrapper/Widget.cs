...
public class Widget : Object, IEditableObject
{
    ...
    public bool IsTopLevel
    {
        get
        {
            return Wrapped.Parent == null || Widget.Lookup (Wrapped.Parent) == null;
        }
    }
    ...
    internal bool RequiresUndoStatusUpdate
    {
        get
        {
            return requiresUndoStatusUpdate;
        }
        set
        {
            requiresUndoStatusUpdate = value;
        }
    }
    ...
    public virtual bool HExpandable
    {
        get
        {
            return hexpandable;
    ...
    public virtual bool VExpandable
    {
        get
        {
            return vexpandable;
...
//				Console.WriteLine ("PROP: " + propertyName);
    ...
    protected virtual bool ClipboardCanCut
    {
        get
        {
            return InternalChildProperty == null && !IsTopLevel;
        }
    }
